...
export default function QuizInstructionScreen({ navigation }) {
  // Sidebar State
        ...
        <View style={styles.sidebarContainer}>
          <View>
            ...
            <ScrollView style={styles.menuScroll} showsVerticalScrollIndicator={false}>
              ...
              <SidebarItem icon="list-check" label="Quiz Center" active onPress={() => { toggleSidebar(); navigation.navigate('StudentQuizCenter'); }} />
      ...
      <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}>
        ...
        <View style={styles.header}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 15 }}>
            <TouchableOpacity onPress={() => navigation.navigate('StudentQuizCenter')}>
        ...
        >
          <View style={styles.contentPadding}>
            ...
            <View style={styles.infoCard}>
              ...
              <Text style={styles.quizTopic}>Ch 5: Arithmetic Progressions</Text>

              <View style={styles.statsGrid}>
                <View style={styles.statCol}>
                  <Text style={styles.statLabel}>TIME</Text>
                  <Text style={styles.statValue}>
                    <FontAwesome5 name="clock" size={12} color="#6366f1" style={{marginRight: 4}} /> 30m
                  </Text>
                </View>
        ...
        <View style={styles.footerContainer}>
          <View style={styles.deadlineRow}>
            <FontAwesome5 name="clock" size={12} color="#f97316" />
            <Text style={styles.deadlineText}>Quiz closes at 5:00 PM</Text>
          </View>
          <TouchableOpacity 
...
const styles = StyleSheet.create({
  ...
  /* Info Card */
  infoCard: { backgroundColor: '#fff', padding: 24, borderRadius: 24, borderWidth: 1, borderColor: '#e2e8f0', marginBottom: 24, alignItems: 'center', overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.02, shadowRadius: 8, elevation: 1 },
  ...
  statLabel: { fontSize: 10, fontWeight: 'bold', color: '#94a3b8', textTransform: 'uppercase', marginBottom: 4, letterSpacing: 0.5 },
  ...
  deadlineRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 16 },
  deadlineText: { fontSize: 12, fontWeight: 'bold', color: '#64748b' },
